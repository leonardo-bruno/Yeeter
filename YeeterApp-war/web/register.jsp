            ...
            <form method="post" action="Register">
                <div style="align-items: center;">
                    ...
                    <div class="alert alert-warning">
                        El usuario contiene caracteres inválidos o no cumple los requisitos. Debe tener al menos 4 caracteres y no usar ni ñ ni acentos
                    </div>
                    <%
                        }
                    %>
                    <div class="input-group mb-3">
                        ...
                        <input type="text" class="form-control <%=invalidUsername%>" placeholder="Username" 
