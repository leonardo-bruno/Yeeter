...
@NamedQueries({
    ...
    , @NamedQuery(name = "Amigos.friendsList", query = "SELECT a.amigosPK.idAmigo FROM Amigos a INNER JOIN Usuario u ON a.amigosPK.idAmigo = u.id WHERE a.amigosPK.idUsuario = :id")})
